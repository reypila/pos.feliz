...
module.exports = {
		...
		Create: function(req, res, next) {
			...
			if (!enums.CheckExist(req.body.price) || !enums.CheckExist(req.body.cost) || !enums.CheckExist(req.body.brand) !enums.CheckExist(req.body.stock) !enums.CheckExist(req.body.name) !enums.CheckExist(req.body.maker)) {
